...
| **Face Detailer** | `zimage_turbo_face_detailer.json` | 双通道增强：Img2Img → 面部检测精修 | ? |
...
| **Anima Img2Img** | `anima_img2img.json` | 参考图 + 文本引导，可控制变化幅度 | 1024×1024 |
...
|------|------|-------|-----------|--------|------|
| Z-Image | 快速预览 | 4 | simple | 1024² | ~5 秒 |
| Z-Image | 日常出图 | 8 | beta | 768×1360 | ~10 秒 |
| Z-Image | 高质量 | 20 | beta | 1024² | ~25 秒 |
| Z-Image | 批量探索 | 8 | beta | 768×1360 | Seed Explorer |
| Anima | 日常出图 | 35 | normal | 1024² | er_sde 采样器 |
| Anima | 高质量 | 50 | normal | 1024²+ | 可上 1536² |
